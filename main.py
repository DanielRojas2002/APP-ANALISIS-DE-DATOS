...
class VentanaP1(QMainWindow):
    def __init__(self):
        ...
        try:
            colores_boton=pd.read_csv("Configuracion/colores_botones.csv",encoding='utf-8')
        ...
        try:
            fuentes=pd.read_csv("Configuracion/fuentes.csv",encoding='utf-8')
    ...
    def Guardar_Color_Ventanas(self):
        ...
        if colorFrame.isValid():
            dicc={}
            lista=[]
            ruta="Configuracion/colores.csv"
    ...
    def Guardar_Color_Botones(self):
        ...
        if colorFrame.isValid():
            dicc={}
            lista=[]
            ruta="Configuracion/colores_botones.csv"
            lista.append(COLORFINAL)
...
class VentanaSeleccionar(QMainWindow):
    def __init__(self,parent=None):
        ...
        try:
            colores=pd.read_csv("Configuracion/colores.csv",encoding='utf-8')
...
class VentanaFuentes(QMainWindow):
    ...
    def cambiar_fuente(self):
        try:
            dicc={}
            lista=[]
            ruta="Configuracion/fuentes.csv"
